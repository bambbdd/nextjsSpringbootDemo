package com.bambbdd.global.security;
...
public class ApiSecurityConfig {
    ...
    @Bean
    SecurityFilterChain apiFilterChain(HttpSecurity http, JwtAuthorizationFilter jwtAuthorizationFilter) throws Exception {
        http
                .securityMatcher("/api/**")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.addAllowedMethod("*"); // 모든 HTTP 메서드 활용
        configuration.addAllowedHeader("*"); // 모든 요청 헤더 활용
